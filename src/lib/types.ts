...
export type ContactWithLatestCommunication = Contact & LatestCommunicationDetails

export type PotentialEntry = Potential & { contact: ContactWithLatestCommunication }
export type IncomingRequestEntry = IncomingRequest & { contact: ContactWithLatestCommunication }
export type ContactedContactEntry = ContactedContact & { contact: ContactWithLatestCommunication }
export type ClientEntry = Client & { contact: ContactWithLatestCommunication }

export type WorkflowStage = "potentials" | "incoming_requests" | "contacted_contacts" | "clients"

export type AddContactFormData = Omit<Contact, "id" | "created_at" | "updated_at">
